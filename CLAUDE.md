...
2. **Scaffold tool** — `packages/xl1-scaffold/` bootstraps a new XL1 app (React dApp or Node service) with the correct dep graph, tsconfig, ESLint, and smoke test wired up
